...
part of 'mock_user_api_service.dart';
...
class _$MockUserApiService extends MockUserApiService {
  _$MockUserApiService([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final definitionType = MockUserApiService;
  ...
  @override
  Future<Response<Credentials>> login(String username, String password) {
