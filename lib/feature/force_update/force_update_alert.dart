...
const PLAY_STORE_URL = 'play store url'; //todo add play store url in config file
    ...
    builder: (BuildContext dialogContext) {
      if (Platform.isIOS) {
        return CupertinoAlertDialog(
          title: Text(Strings.localizedString(context, StringKey.update_alert_title)),
          content: Text(Strings.localizedString(context, StringKey.update_alert_message_ios)),
          actions: [
            FlatButton(
              child:
              Text((Strings.localizedString(dialogContext, StringKey.update_cta))),
              onPressed: () {
        ...
        return WillPopScope(
          ...
          child: AlertDialog(
            title: Text(Strings.localizedString(context, StringKey.update_alert_title)),
            content: Text(Strings.localizedString(context, StringKey.update_alert_message_android)),
            actions: [
              FlatButton(
                child:
                Text((Strings.localizedString(dialogContext, StringKey.update_cta))),
